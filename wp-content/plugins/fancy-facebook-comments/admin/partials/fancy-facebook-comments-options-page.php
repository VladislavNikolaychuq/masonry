				...
				<div class="stuffbox">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
						<tr>
							<td colspan="2">
							<div>
							<a href="https://www.heateor.com/fancy-facebook-comments-pro" target="_blank" style="text-decoration:none"><input type="button" value="<?php _e( 'Enable Facebook Comments notification and moderation', 'fancy-facebook-comments' ) ?> >>>" class="ss_demo" /></a>
							</div>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
							<div>
							<a href="https://www.heateor.com/fancy-facebook-comments-pro" target="_blank" style="text-decoration:none"><input type="button" value="<?php _e( 'Show Recent Facebook Comments in a Widget', 'fancy-facebook-comments' ) ?> >>>" class="ss_demo" /></a>
							</div>
							</td>
						</tr>
